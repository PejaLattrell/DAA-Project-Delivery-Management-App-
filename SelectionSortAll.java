public class SelectionSortAll {
    ...
    public static void main(String[] args) {
        ...
        selectionSort(productNames, weights, amounts, "name");
        printResults("Sorted by Product Name:", productNames, weights, amounts);

        selectionSort(weights, productNames, amounts, "weight");
        printResults("Sorted by Weight:", productNames, weights, amounts);

        selectionSort(amounts, productNames, weights, "amount");
        printResults("Sorted by Amount:", productNames, weights, amounts);
    }
